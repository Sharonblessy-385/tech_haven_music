    ...
    <section className='h-[100%] w-[100%] flex  justify-center items-center' >
        <article className='h-[420px] w-[50%]  bg-slate-800 rounded-md'>
          <header className='h-[120px] w-[95%] mt-3 m-auto bg-slate-700 rounded-md relative'>
            <picture className='absolute top-[-55px] left-[230px]'>
          ...
          <main>
           {userDataFromDB==null ?  <div className='h-full w-[100%] flex flex-col items-center gap-2 mt-2'>
              <picture>
            ...
            <section className='h-[290px] w-full '> 
            <header className='flex items-center justify-between'><h1 className='text-[24px] font-semibold py-2 px-4'>Personal Details</h1>
            <NavLink to={"/user-profile/add-profile"} state={userDataFromDB}><span className='text-[24px]'><FaUserEdit /></span></NavLink></header>
